...
class VisHtmlTable {
  ...
  async createHTML() {
    ...
    for (const state in this.stateVal) {
      ...
      let iTag = "";
      let iTagEnd = "";
      let font_text_color = this.htmlVal.font_color_text_enabled;
      if (!data.enabled) {
        iTag = `<i>`;
        iTagEnd = `</i>`;
      ...
      for (const trigger of data.triggers) {
        ...
        triggers += `
                ...
                <td id="weekday" onClick="changeweekdays('${this.adapter.namespace}', 'week', '${state}', '${trigger.id}', 1, '${trigger.type}')" style="cursor: pointer; text-align:${this.htmlVal.column_align_row_04}; ${today_style[1]} color:${trigger.weekdays && trigger.weekdays.includes(1) ? this.htmlVal.font_color_weekdays_enabled : this.htmlVal.font_color_weekdays_disabled};">${iTag}${this.htmlVal.column_text_04}${iTagEnd}</td>
                <td id="weekday" onClick="changeweekdays('${this.adapter.namespace}', 'week', '${state}', '${trigger.id}', 2, '${trigger.type}')" style="cursor: pointer; text-align:${this.htmlVal.column_align_row_05}; ${today_style[2]} color:${trigger.weekdays && trigger.weekdays.includes(2) ? this.htmlVal.font_color_weekdays_enabled : this.htmlVal.font_color_weekdays_disabled};">${iTag}${this.htmlVal.column_text_05}${iTagEnd}</td>
                <td id="weekday" onClick="changeweekdays('${this.adapter.namespace}', 'week', '${state}', '${trigger.id}', 3, '${trigger.type}')" style="cursor: pointer; text-align:${this.htmlVal.column_align_row_06}; ${today_style[3]} color:${trigger.weekdays && trigger.weekdays.includes(3) ? this.htmlVal.font_color_weekdays_enabled : this.htmlVal.font_color_weekdays_disabled};">${iTag}${this.htmlVal.column_text_06}${iTagEnd}</td>
                <td id="weekday" onClick="changeweekdays('${this.adapter.namespace}', 'week', '${state}', '${trigger.id}', 4, '${trigger.type}')" style="cursor: pointer; text-align:${this.htmlVal.column_align_row_07}; ${today_style[4]} color:${trigger.weekdays && trigger.weekdays.includes(4) ? this.htmlVal.font_color_weekdays_enabled : this.htmlVal.font_color_weekdays_disabled};">${iTag}${this.htmlVal.column_text_07}${iTagEnd}</td>
                <td id="weekday" onClick="changeweekdays('${this.adapter.namespace}', 'week', '${state}', '${trigger.id}', 5, '${trigger.type}')" style="cursor: pointer; text-align:${this.htmlVal.column_align_row_08}; ${today_style[5]} color:${trigger.weekdays && trigger.weekdays.includes(5) ? this.htmlVal.font_color_weekdays_enabled : this.htmlVal.font_color_weekdays_disabled};">${iTag}${this.htmlVal.column_text_08}${iTagEnd}</td>
                <td id="weekday" onClick="changeweekdays('${this.adapter.namespace}', 'week', '${state}', '${trigger.id}', 6, '${trigger.type}')" style="cursor: pointer; text-align:${this.htmlVal.column_align_row_09}; ${today_style[6]} color:${trigger.weekdays && trigger.weekdays.includes(6) ? this.htmlVal.font_color_weekdays_enabled : this.htmlVal.font_color_weekdays_disabled};">${iTag}${this.htmlVal.column_text_09}${iTagEnd}</td>
                <td id="weekday" onClick="changeweekdays('${this.adapter.namespace}', 'week', '${state}', '${trigger.id}', 0, '${trigger.type}')" style="cursor: pointer; text-align:${this.htmlVal.column_align_row_10}; ${today_style[0]} color:${trigger.weekdays && trigger.weekdays.includes(0) ? this.htmlVal.font_color_weekdays_enabled : this.htmlVal.font_color_weekdays_disabled};">${iTag}${this.htmlVal.column_text_10}${iTagEnd}</td>
                </tr>`;
      ...
      status = `${data.onAction.onValue}/${data.onAction.offValue}&ensp;${data.enabled ? this.htmlVal.icon_true : this.htmlVal.icon_false}`;
  ...
  helper_translator(word) {
    const all = {
      ...
      goldenHourEnd: {
        en: "End golden dusk",
        de: "Ende goldenen D\xE4mmerung",
        ru: "\u041A\u043E\u043D\u0435\u0446 \u0437\u043E\u043B\u043E\u0442\u044B\u0445 \u0441\u0443\u043C\u0435\u0440\u0435\u043A",
        pt: "Fim do crep\xFAsculo dourado",
        nl: "Einde gouden schemering",
        fr: "cr\xE9puscule dor\xE9",
        it: "Fine del crepuscolo dorato",
        es: "Fin del crep\xFAsculo dorado",
      ...
      goldenHour: {
        ...
        de: "Beginn goldenen D\xE4mmerung",
        ru: "\u041D\u0430\u0447\u0430\u0442\u044C \u0437\u043E\u043B\u043E\u0442\u044B\u0435 \u0441\u0443\u043C\u0435\u0440\u043A\u0438",
        pt: "Comece o crep\xFAsculo dourado",
        nl: "Begin gouden schemering",
        fr: "D\xE9but du cr\xE9puscule dor\xE9",
        it: "Inizia il crepuscolo dorato",
        es: "Comienza el crep\xFAsculo dorado",
      ...
      sunsetStart: {
        ...
        ru: "\u041D\u0430\u0447\u0430\u0442\u044C \u0437\u0430\u043A\u0430\u0442",
        pt: "Come\xE7ar o p\xF4r do sol",
        nl: "Begin zonsondergang",
        fr: "D\xE9but du coucher du soleil",
        it: "Inizio tramonto",
        es: "Comienza el atardecer",
        pl: "Rozpocznij zach\xF3d s\u0142o\u0144ca",
      ...
      nauticalDusk: {
        en: "Nautical dusk",
        de: "Nautische D\xE4mmerung",
        ru: "\u041C\u043E\u0440\u0441\u043A\u0438\u0435 \u0441\u0443\u043C\u0435\u0440\u043A\u0438",
        pt: "Crep\xFAsculo n\xE1utico",
        nl: "Nautische schemering",
        fr: "cr\xE9puscule nautique",
        it: "Crepuscolo nautico",
        es: "Atardecer n\xE1utico",
        pl: "Zmierzch morski",
        uk: "\u041C\u043E\u0440\u0441\u044C\u043A\u0456 \u0441\u0443\u0442\u0456\u043D\u043A\u0438",
        "zh-cn": "\u822A\u6D77\u9EC4\u660F"
      },
      ...
      nauticalDawn: {
        en: "Nautical dawn",
        de: "Nautische Morgend\xE4mmerung",
        ru: "\u041C\u043E\u0440\u0441\u043A\u043E\u0439 \u0440\u0430\u0441\u0441\u0432\u0435\u0442",
        pt: "amanhecer n\xE1utico",
        nl: "Nautische dageraad",
        fr: "Aube nautique",
        it: "Alba nautica",
        es: "Amanecer n\xE1utico",
        pl: "Morski \u015Bwit",
