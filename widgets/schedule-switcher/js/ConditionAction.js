(async () => {
    class ConditionAction extends HTMLElement {
        ...
        conditionStateIdsAndAlias() {
            return vis.binds["schedule-switcher"].getConditionStateIdsAndAlias(this.getAttribute("widgetid"));
        }
        ...
        createShadowRoot() {
            ...
            shadowRoot.innerHTML = `
				...
				<link rel="stylesheet" href="widgets/schedule-switcher/css/ConditionAction.css" />
				...
				<div class="container edit" style="display: none">
					...
					<div class="condition-body">
						...
						<div id="withConstant" class="md-switch-container">
							...
							<div class="md-switch-label">${vis.binds["schedule-switcher"].translate("withConstant")}</div>
						</div>
    ...
    customElements.define("app-condition-action-schedule", ConditionAction);
})();
